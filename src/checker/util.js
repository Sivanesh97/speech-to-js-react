export function BuiltInMethod(name, methodName, type) {
	  this.name = name
...
export function ConditionalWithArgs(type) {
    this.name = ""
	this.type = type
	this.methodName = ""
...
export function Arrow(name, type) {
	this.name = name
	this.type = type
	this.methodName = ""
    this.body = []
...
export function Console(methodName, type) {
	  this.name = ""
      this.methodName = methodName
	  this.type = type
	  this.arguments = []
...
Console.prototype.toString = function() {
   if(this.type.startsWith('console')) {
       if(this.methodName.startsWith('log')) 
...
export function SingleLineComment(type) {
     this.name = ''
	 this.methodName = ''
	 this.type = type
	 this.arguments = []
...
export function MultiLineComment(type) {
	 this.name = ''
	 this.methodName = ''
	 this.type = type
	 this.arguments = []
